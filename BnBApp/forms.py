...
class predictForm(Form):
    accommodates = FloatField('accommodates')
    bathrooms = FloatField('bathrooms')
    bedrooms = FloatField('bedrooms')
    beds = FloatField('beds')
    cancellation_policy = SelectField('cancellation_policy', choices=[('Choose Cancellation Policy', 'Choose Cancellation Policy'), ('flexible', 'flexible'), ('moderate', 'moderate'), ('strict', 'strict')], default=1)
    ...
    neighbourhood = SelectField('neighbourhood', choices=[('Choose a Neighborhood', 'Choose a Neighborhood'),
